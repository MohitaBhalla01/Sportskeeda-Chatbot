...
var bot = new builder.UniversalBot(connector, function (session) {
    ...
    if (!session.conversationData[CityKey]) {
        session.conversationData[CityKey] = 'Lucknow';
        session.send('Welcome to the City bot. I\'m currently configured to search for things in %s', session.conversationData[CityKey]);
    }
